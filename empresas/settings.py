...
SECRET_KEY = '$&k(pv@hlqx$k2-gm%x*xolav=d2g97q_k%73i1awk1^jux29d'
...
#crisxztian.mysql.pythonanywhere-services.com
...
STATIC_URL = '/static/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'aguadedios/static/media')
MEDIA_URL = '/media/'
